...
for (i in 1:nrow(annotations)) {
  ...
  model_data <- data.frame(
    Intensity = intensity_vector[intensity_cutoff:length(intensity_vector)],
    Radial_distance = 1:length(intensity_vector[intensity_cutoff:length(intensity_vector)])
    )
  ...
  Harvey_intesity_cutoff <- which.max(intensity_vector)
  ...
  data.frame(
    ...
    geom_vline(xintercept = Harvey_intesity_cutoff, col = "blue")
    scale_y_reverse() +
    labs(
